  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Colors.teal, // Ganti warna appbar menjadi teal
      ),
...
class MealItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      color: Colors.orangeAccent, // Ganti warna card menjadi orangeAccent
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: Colors.deepPurple, // Ganti warna teks menjadi deepPurple
                ),
